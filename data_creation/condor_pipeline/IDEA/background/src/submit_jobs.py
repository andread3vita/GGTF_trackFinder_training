...
def main(base_path):
    ...
    parser.add_argument("--k4geoPath", help="k4geoPath", default="")
    parser.add_argument("--k4fwcorePath", help="k4fwcorePath", default="")
    ...
    k4geoPath = parsed_args.k4geoPath
    k4fwcorePath = parsed_args.k4fwcorePath
    ...
    script = f"{mainDir}/src/runSequence.sh"
    ...
    for seed in range(minseed, minseed + njobs):
        ...
        if not matching_files:
            ...
            argts = (f"{outdir} {train_or_val} {seed} {base_path} {key4hep_version} {k4geoPath} {k4fwcorePath}")
